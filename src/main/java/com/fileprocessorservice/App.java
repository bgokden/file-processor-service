...
/**
 * Utility class which creates {@link Application} instances and provides support
...
public class App {
    ...
    public static void main(String[] args) {
        try {
            ...
            final Server server = JettyHttpContainerFactory.createServer(BASE_URI, createApp());
